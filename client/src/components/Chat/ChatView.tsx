    ...
    <ChatFormProvider {...methods}>
      <ChatContext.Provider value={chatHelpers}>
        <AddedChatContext.Provider value={addedChatHelpers}>
          <Presentation mainClass='overflow-hidden relative' useSidePanel={true}>
            {content}
            ...
            <motion.div
              className={[
                'w-[1028px] h-[1028px] bg-[radial-gradient(50%_50%_at_50%_100%,_rgba(70,60,255,1)_0%,_rgba(70,60,255,0.00)_100%)] opacity-45 mx-auto absolute bottom-[-140px] left-1/2 -translate-x-1/2 pointer-events-none',
                chatHelpers.isSubmitting ? 'animate-stream-bg': '',
              ].join(' ')}
            ...
            >
              <div
                className={[
                  ...
                  chatHelpers.isSubmitting ? 'animate-stream-orb': '',
                ].join(' ')}>
              </div>
            </div>
          </Presentation>
